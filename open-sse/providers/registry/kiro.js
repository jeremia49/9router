export default {
  ...
  models: [
    ...
    { id: "claude-opus-4.8-thinking", name: "Claude Opus 4.8 (Thinking)", contextLength: 1000000 },
    { id: "claude-opus-4.8-agentic", name: "Claude Opus 4.8 (Agentic)", contextLength: 1000000 },
    { id: "claude-opus-4.8-thinking-agentic", name: "Claude Opus 4.8 (Thinking + Agentic)", contextLength: 1000000 },
    { id: "claude-opus-4.7", name: "Claude Opus 4.7", contextLength: 1000000 },
    { id: "claude-opus-4.7-thinking", name: "Claude Opus 4.7 (Thinking)", contextLength: 1000000 },
    { id: "claude-opus-4.7-agentic", name: "Claude Opus 4.7 (Agentic)", contextLength: 1000000 },
    { id: "claude-opus-4.7-thinking-agentic", name: "Claude Opus 4.7 (Thinking + Agentic)", contextLength: 1000000 },
    ...
    { id: "claude-opus-4.5-agentic", name: "Claude Opus 4.5 (Agentic)", contextLength: 200000 },
    { id: "claude-opus-4.5-thinking-agentic", name: "Claude Opus 4.5 (Thinking + Agentic)", contextLength: 200000 },
    // Sonnet
    ...
    // Non-Anthropic
    { id: "deepseek-3.2", name: "DeepSeek 3.2", contextLength: 128000, strip: ["image","audio"] },
    { id: "qwen3-coder-next", name: "Qwen3 Coder Next", contextLength: 256000, strip: ["image","audio"] },
    ...
    // Thinking variants
    { id: "claude-sonnet-5-thinking", name: "Claude Sonnet 5 (Thinking)", contextLength: 1000000 },
    { id: "claude-sonnet-4.5-thinking", name: "Claude Sonnet 4.5 (Thinking)", contextLength: 200000 },
    { id: "claude-haiku-4.5-thinking", name: "Claude Haiku 4.5 (Thinking)", contextLength: 200000 },
    ...
    // Agentic variants
    { id: "claude-sonnet-5-agentic", name: "Claude Sonnet 5 (Agentic)", contextLength: 1000000 },
    { id: "claude-sonnet-4.5-agentic", name: "Claude Sonnet 4.5 (Agentic)", contextLength: 200000 },
    { id: "claude-haiku-4.5-agentic", name: "Claude Haiku 4.5 (Agentic)", contextLength: 200000 },
    ...
    { id: "claude-sonnet-5-thinking-agentic", name: "Claude Sonnet 5 (Thinking + Agentic)", contextLength: 1000000 },
    { id: "claude-sonnet-4.5-thinking-agentic", name: "Claude Sonnet 4.5 (Thinking + Agentic)", contextLength: 200000 },
    { id: "claude-haiku-4.5-thinking-agentic", name: "Claude Haiku 4.5 (Thinking + Agentic)", contextLength: 200000 },
