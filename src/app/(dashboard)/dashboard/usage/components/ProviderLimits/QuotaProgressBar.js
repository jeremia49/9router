...
export default function QuotaProgressBar({
	...
	// For text-only display (e.g., t3chat balance), show remaining value instead of percentage
	const displayValue = displayAsText ? used : remaining;
	...
	return (
		<div className="space-y-2">
			...
			<div className="flex items-center justify-between text-xs text-text-muted">
				<span>
					{displayAsText
						? `${(total - used).toLocaleString()} / ${total.toLocaleString()} remaining`
