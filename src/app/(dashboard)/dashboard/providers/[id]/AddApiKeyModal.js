...
export default function AddApiKeyModal({
	...
	else if (provider === "grok-web" && isCookie)
		credentialPlaceholder = "sso=xxxxx... or just the raw value";
					...
					<>
						...
						{isT3Chat && (
							<Input
								...
								onChange={(e) =>
									setFormData({ ...formData, convexSessionId: e.target.value })
								}
						...
						<div className="flex gap-2">
							<Button
								...
								disabled={
									...
									(isT3Chat && !formData.convexSessionId.trim()) ||
